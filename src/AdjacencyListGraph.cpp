...
//     VertexAdj<T>* v_adj = dynamic_cast<VertexAdj<T>*>(v);
// 
...
//     EdgeAdj<T>* edge = dynamic_cast<EdgeAdj<T>*>(e);
// 
//     VertexAdj<T>* start = dynamic_cast<VertexAdj<T>*>(edge->Start());
//     VertexAdj<T>* end = dynamic_cast<VertexAdj<T>*>(edge->End());
// 
...
//     VertexAdj<T>* v_adj = dynamic_cast<VertexAdj<T>*>(v);
//     VertexAdj<T>* w_adj = dynamic_cast<VertexAdj<T>*>(w);
// 
//     for (EdgeAdj<T>* edge : v_adj->list_Edge_adj()) {
//         if (edge->End() == w_adj) {
